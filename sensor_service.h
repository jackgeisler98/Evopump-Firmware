...
#define BLE_UUID_SENSOR_CHARACTERISTIC_UUID          0xBEEF // Just a random, but recognizable value
...
typedef struct
{
    ...
    ble_gatts_char_handles_t char_handles;  //handles related to sensor measurement characteristic
}ble_sensor_t;
